...
public class UniWebViewAuthenticationFlowSpotify : UniWebViewAuthenticationCommonFlow, IUniWebViewAuthenticationFlow<UniWebViewAuthenticationSpotifyToken>
{
    /// <summary>
    ...
    /// <summary>
    /// The grant type of your OAuth application.
    /// </summary>
    public string grantType = "authorization_code";

    /// <summary>
    /// The refresh token grant type of your OAuth application.
    /// </summary>
    ...
    /// </summary>
    public UniWebViewAuthenticationFlowSpotifyOptional optional;
    ...
    public UnityEvent<UniWebViewAuthenticationSpotifyToken> OnAuthenticationFinished { get; set; }
    ...
    /// </summary>
    [field: SerializeField]
    public UnityEvent<UniWebViewAuthenticationSpotifyToken> OnRefreshTokenFinished { get; set; }
    ...
    public Dictionary<string, string> GetAccessTokenRequestParameters(string authResponse)
    {
        ...
        var response = UniWebViewAuthenticationSpotifyUtils.ParseFormUrlEncodedString(uri.Query);
    ...
    {
        return UniWebViewAuthenticationTokenFactory<UniWebViewAuthenticationSpotifyToken>.Parse(exchangeResponse);
    }
}

/// <summary>
/// The authentication flow's optional settings for Spotify.
/// </summary>
[Serializable]
...
/// </summary>
public class UniWebViewAuthenticationSpotifyToken : UniWebViewAuthenticationStandardToken
{
