...
public class SurfViewModel : ViewModel
{
    ...
    {       
        CallPopUP(PopUpViewModelTypes.MessageOnly, "¿Qué son las PIKCoins?", "Cada vez que escuches una canción que te haga vibrar, puedes lanzar un disco para votar por tus favoritas y destacar en el ranking. <color=#7C7DF5>(1 PIKCoin = 1 Voto)</color> <br>", "Aceptar", image);
#if PLATFORM_ANDROID
